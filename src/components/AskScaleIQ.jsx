...
const routes = [
  ...
  { match: ['what we look for', 'look for', 'criteria', 'qualify', 'does scaleiq acquire', 'what kind of companies'], to: '/portfolio/our-companies' },
  ...
  { match: ['investment policy', 'how does scaleiq invest', 'investment approach', 'how we grow'], to: '/about/how-we-grow' },
  { match: ['oges', 'wipa', 'hvms', 'udbhav'], to: '/portfolio/our-companies' },
