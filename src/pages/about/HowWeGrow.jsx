...
import ExpandableTileGrid from '../../components/ExpandableTileGrid';
...
const principles = [
  { title: 'Domain Driven', body: 'ScaleIQ and its portfolio companies engage deeply with oil & gas domain experts before proposing any solution. Constraints, decision logic, and risk on the ground shape every product decision, not abstract best practices imported from other industries.' },
  { title: 'Focused High-Impact AI', body: 'Every portfolio company prioritizes AI use cases tightly linked to real operational and commercial outcomes, not experiments that never leave a slide deck.' },
  { title: 'Outcomes Over Offerings', body: "ScaleIQ companies are built to solve problems end-to-end, not to sell a fixed menu of services. What needs to work matters more than what's easiest to package." },
  { title: 'One Cohesive System', body: 'Capabilities and domain expertise come together under a single standard across the group, so data stays consistent and architecture holds up group-wide, not just project by project.' },
  { title: 'Deep Data Engineering', body: 'Every ScaleIQ company works to connect fragmented data across upstream, midstream, and downstream systems, building the kind of trusted, governed data environment energy operations actually need.' },
];
...
export default function HowWeGrow() {
  ...
  return (
    <>
      <PageHeader eyebrow="About" title="How We Grow" />
      <div className="hub-layout wrap">
        ...
        <div className="hub-sections">
          ...
          <section id="look-for" className="hub-section reveal">
          ...
          <section id="principles" className="hub-section reveal">
            <div className="hub-eyebrow">Our Principles</div>
            <ExpandableTileGrid tiles={principles} />
          </section>

          <section id="why-founders" className="hub-section reveal">
            <div className="hub-eyebrow">Why Founders Choose ScaleIQ</div>
            <StaggeredChecklist items={whyFounders} />
          </section>

          <section id="numbers" className="hub-section reveal">
